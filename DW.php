    ...
    <div class="row row-cols-1 row-cols-md-3">
        <div class="col mb-4">
            <div class="card h-100">
                <img src="Images/PDW12.png" class="card-img-top" alt="ABM DW 10">
                <div class="card-body">
                    <h5 class="card-title">ABM DW 10</h5>
                    <p class="card-text">ABM DW 10 is Double Wheel, Cricket Bowling Machine suitable for beginners or
                        junior level cricketers. More robust and feature rich for 3 axis variation ( Line, Length and
                        Height ).
                        These machines can be operated remotely( <b>*Optional</b> ).
                    </p>
        ...
        <div class="col mb-4">
            <div class="card h-100">
                <img src="Images/PPDW12.png" class="card-img-top" alt="ABM SW 12">
                <div class="card-body">
                    <h5 class="card-title">ABM DW 12</h5>
                    <p class="card-text">ABM DW 12 is Double Wheel, Cricket Bowling Machine suitable for intermediate
                    ...
                    <p class="text-primary">* <b>Spin ( Leg and Off ) </b></p>
                    <p class="text-primary">* <b>Spot Pitching </b></p>
                    <p class="text-primary">* <b>Speed up to 140 kmph </b></p>
                    <p class="text-primary">* <b>Adjustment to release Dimple and Tennis Balls </b></p>
                </div>
            </div>
        </div>
        <div class="col mb-4">
            <div class="card h-100">
                <img src="Images/BPPDW14.png" class="card-img-top" alt="ABM SW 14">
                <div class="card-body">
                    <h5 class="card-title">ABM DW 14</h5>
                    <p class="card-text">ABM DW 14 is Double Wheel, Cricket Bowling Machine suitable for junior level
                    ...
                    <p class="text-primary">* <b>Spin ( Leg and Off ) </b></p>
                    <p class="text-primary">* <b>Spot Pitching </b></p>
                    <p class="text-primary">* <b>Speed up to 160 kmph </b></p>
                    <p class="text-primary">* <b>Adjustment to release Dimple and Tennis Balls </b></p>
                </div>
            </div>
        </div>
