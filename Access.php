    ...
    <div class="row row-cols-1 row-cols-md-3">
        <div class="col mb-4">
            <div class="card h-100">
                <img src="Images/YellowDimp.jpg" class="card-img-top" alt="ABM DW 10">
                <div class="card-body">
                    <h5 class="card-title">Large DOT Dimple Balls</h5>
                    
                    <span class="blink_text"><b>Features</b></span>
                    <!-- <h5 class="text-danger" >Features</h5> -->
                    <p class="text-primary">* <b>Large Dot for better grip </b></p>
                    <p class="text-primary">* <b>Accurate weight</b></p>
                    <p class="text-primary">* <b>Colur variants available</b></p>
                    <p class="text-primary">* <b>Suitable for All machines</b></p>
                    <p class="text-primary">* <b>Weight ranges from 120 to 140 gm .. </b></p>
					<p class="card-text"> Large dot dimple balls are used widely in Cricket Balling Machines. Dimple ball retains it shapes for longer duration 
					than the seasoned balls and hence it is preferred with Cricket/Baseball machines. The weight of the ball is adequate for simulating the real
feel of seasoned cricket balls to practice all variations.					
                    </p>
                </div>
            </div>
        </div>
        <div class="col mb-4">
            <div class="card h-100">
                <img src="Images/Reddimp.jpg" class="card-img-top" alt="ABM SW 12">
                <div class="card-body">
                    <h5 class="card-title">Large DOT RED Dimple Balls</h5>
                    <span class="blink_text"><b>Features</b></span>
                    <!-- <h5 class="text-danger" >Features</h5> -->
                    <p class="text-primary">* <b>Large Dot for better grip </b></p>
                    <p class="text-primary">* <b>More Bounce to practice Short Pitched Deliveries</b></p>
                    <p class="text-primary">* <b>Better suited for Spin</b></p>
                    <p class="text-primary">* <b>Suitable for All machines</b></p>
                    <p class="text-primary">* <b>Longivity and Durability </b></p>
					<p class="card-text"> Large dot red dimple balls are used widely in Cricket Balling Machines. Dimple ball retains it shapes for longer duration 
					than the seasoned balls and hence it is preferred with Cricket/Baseball machines. The weight of the ball is adequate for simulating the real
feel of seasoned cricket balls to practice all variations.					
                    </p>
                </div>
        ...
        <div class="col mb-4">
            <div class="card h-100">
                <img src="Images/Yellowsmalldimp.jpg" class="card-img-top" alt="ABM SW 14">
                <div class="card-body">
                    <h5 class="card-title">Small DOT Dimple Balls</h5>
                    
                    <span class="blink_text"><b>Features</b></span>
                    <!-- <h5 class="text-danger" >Features</h5> -->
                    <p class="text-primary">* <b>Small Dot ensures more air resistance </b></p>
                    <p class="text-primary">* <b>Can be used on slight wet surfaces</b></p>
                    <p class="text-primary">* <b>Colur variants available</b></p>
                    <p class="text-primary">* <b>Better visibility of the ball for night practice as well</b></p>
                    <p class="text-primary">* <b>Weight ranges from 120 to 140 gm .. </b></p>
					<p class="card-text"> Small dot dimple balls are used widely in Cricket Balling Machines. Dimple ball retains it shapes for longer duration 
					than the seasoned balls and hence it is preferred with Cricket/Baseball machines. The weight of the ball is adequate for simulating the real
feel of seasoned cricket balls to practice all variations.					
                    </p>
                </div>
